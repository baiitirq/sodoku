...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="estilo_sumar.css">
    ...
    <div class="contenedor"> 
        ...
        <Table>
            <tr>
                ...
                <td class="no-contiene" id="0" ondrop="drop(avent)" ondragover="allowDrop(event)"></td>
                <td class="contiene">=</td>
            ...
            <tr>
                <td class="no-contiene" id="1" ondrop="drop(avent)" ondragover="allowDrop(event)"></td>
                <td class="contiene">+</td>
